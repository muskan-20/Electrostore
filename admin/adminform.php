...
if(isset($_POST['submitbtn'])){
    ...
    $email1 = $_POST['email'];
    $pwd = $_POST['password'];
    $query = mysqli_query($connection, "insert into tbl_admin (admin_name,admin_email, admin_password) values('{$name1}','{$email1}','{$pwd}')") or die("error in query" . mysqli_error($connection));
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="adminform.php">
                <div class="card-body">
