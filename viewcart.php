            ...
            <div class="container py-xl-4 py-lg-2">
                ...
                if (isset($_SESSION['registerid'])) {
                    ...
                    if ($_POST) {
                        ...
                        $insertq = mysqli_query($connection, "insert into tbl_order(`order_date`, `order_status` ,`shipping_name`, `shipping_mobile`, `shipping_address`) value('{$currentdate}','pending','{$name}','{$mobile}','{$address}')")or die(mysqli_error($connection));
                        ...
                        foreach ($_SESSION['productcart'] as $key => $value) {
                            ...
                            $insertdetail = mysqli_query($connection, "insert into tbl_order_detail (order_id,product_id,product_qty,product_price) values('{$orderid}','{$value}','{$qty}','{$product['product_price']}')")or die(mysqli_error($connection));
                        }
                        ...
                        echo '<a href="login.php" >Please Login for Checkout</a>';
                        echo '<script>alert("can not place order"):</script>';
                    }
                ?>
